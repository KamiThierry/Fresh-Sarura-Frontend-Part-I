...
const AddCertificateDrawer = ({ isOpen, onClose, onSubmit }: AddCertificateDrawerProps) => {
    ...
    return (
        <div className="fixed top-16 left-0 right-0 bottom-0 z-50 overflow-hidden">
            ...
            <div className="absolute inset-y-0 right-0 max-w-full flex">
                <div className="w-screen max-w-md transform transition-transform duration-300 ease-in-out bg-white dark:bg-gray-800 shadow-xl h-full flex flex-col border-l border-gray-200 dark:border-gray-700">

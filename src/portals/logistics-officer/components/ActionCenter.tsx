import { AlertTriangle, Clock, FileWarning, ArrowRight, Phone, Truck, Upload } from 'lucide-react';
    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden h-full flex flex-col">
                    ...
                    <div key={alert.id} className="group">
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <button className={`mt-3 w-full flex items-center justify-center gap-2 py-1.5 px-3 rounded-lg text-xs font-bold transition-all ${alert.btnColor}`}>
                                    <alert.actionIcon size={14} />
                                    {alert.action}
                                </button>
                            </div>
                        </div>
            ...
            <div className="p-3 border-t border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/30">
                <button className="w-full text-xs font-medium text-gray-500 hover:text-gray-900 dark:hover:text-gray-300 transition-colors">

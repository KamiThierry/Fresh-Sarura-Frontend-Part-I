    ...
    return (
        <header className="fixed top-[10px] left-[10px] right-[10px] h-16 bg-white/80 dark:bg-gray-800/90 backdrop-blur-md border border-gray-200 dark:border-gray-700 z-40 px-6 flex items-center justify-between transition-colors duration-300 rounded-2xl shadow-sm">
            <div className="flex items-center gap-3">
                ...
                <div>
                    <h1 className="text-base font-bold text-green-700 dark:text-green-500 tracking-tight">Logistics Officer</h1>
                    <p className="text-[10px] font-medium text-gray-500 dark:text-gray-400">Regional Hub</p>
                </div>
            </div>
            ...
            <div className="flex-1 max-w-md mx-8 hidden md:block">
                <div className="relative">
                    ...
                    <input
                        type="text"
                        placeholder="Search shipments, drivers, AWBs..."
            ...
            <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-3 pl-2 border-l border-gray-200 dark:border-gray-700">
                    <div className="text-right hidden md:block">
                        ...
                        <p className="text-xs text-[#6B7280] dark:text-gray-400">Ops Team</p>
                    </div>
